...
Example:
  python3 Models/trainSER.py \
    --df_path ./speech26/data/TESS_df.pkl \
 ...
 python3 Models/trainSER.py     --df_path ./speech26/data/TESS_df.pkl     --batch_size 32 --epochs 50 --lr 3e-4     --checkpoint Models/checkpoint/best_model_tess.pth 
python3 Models/trainSER.py     --df_pat ./speech26/data/Crema-D.pkl     --batch_size 32 --epochs 100 --lr 3e-4     --checkpoint Models/checkpoint/best_model_Crema-D.pth  --include_emotions fear neutral happy angry disgust surprise sad
